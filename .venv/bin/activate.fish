...
set -gx VIRTUAL_ENV /home/runner/work/nimachaharbaghi.github.io/nimachaharbaghi.github.io/.venv
...
if test -n 'personal portfolio-py3.10'
    set -gx VIRTUAL_ENV_PROMPT 'personal portfolio-py3.10'
else
