...
class _VirtualEnvActivator:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.embedded_virtual_env = '/home/runner/work/nimachaharbaghi.github.io/nimachaharbaghi.github.io/.venv'
            self.embedded_virtual_prompt = 'personal portfolio-py3.10'
            self.embedded_bin_name = 'bin'
